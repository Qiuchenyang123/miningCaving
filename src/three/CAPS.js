import THREE from '../assets/lib/three'
...
/* CAPS.PlaneGeometry = class PlaneGeometry extends THREE.PlaneGeometry {
...
CAPS.PlaneGeometry.prototype = new THREE.PlaneGeometry()
...
CAPS.Simulation = class Simulation {
	constructor({ scene, camera, canvas, renderer, control, group }) {
		...
		this.init({ scene, camera, canvas, renderer, control, group })
	}

	init({ scene, camera, canvas, renderer, control, group }) {
		var self = this
